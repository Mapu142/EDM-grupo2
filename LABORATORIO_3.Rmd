...
Cuando se hace un ACP a partir de una matriz de correlaciones (es decir, cuando las variables han sido estandarizadas), las coordenadas de las variables sobre los componentes principales son iguales a las correlaciones entre las variables originales y los componentes. EN este caso las correlaciones y las coordenadas tambien son iguales.
